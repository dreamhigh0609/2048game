...
class Tile {
  ...
  void reverseTo(Animation<double> parent, int x, int y) {
    Animation<double> curved =
        CurvedAnimation(parent: parent, curve: Interval(0.0, moveInterval));
    animatedX =
        Tween(begin: x.toDouble(), end: this.x.toDouble()).animate(curved);
    animatedY =
        Tween(begin: y.toDouble(), end: this.y.toDouble()).animate(curved);
  }
...
class UndoButton extends StatelessWidget {
  ...
  const UndoButton({Key key, this.onPressed}) : super(key: key);
